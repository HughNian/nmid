...
public final class Constants {
    ...
    public static final Duration DEFAULT_TIME_OUT = Duration.ofMillis(30);
    public static final int DIAL_TIME_OUT = 6000;
    public static final Duration CLIENT_ALIVE_TIME = Duration.ofSeconds(1800);
    public static final Duration DEFAULT_HEARTBEAT_TIME = Duration.ofSeconds(10);
